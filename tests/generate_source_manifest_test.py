...
class GenerateSourceManifestTest(unittest.TestCase):
    def test_stable_allowlist_and_exclusions(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            (root / "tests" / "data" / "fixture.npy").write_bytes(b"npy")
            (root / "data").mkdir()
            (root / "data" / "runtime.bin").write_bytes(b"runtime")
        ...
        self.assertIn("./tests/data/fixture.npy", paths)
        self.assertNotIn("./data/runtime.bin", paths)
